...
export default function CreateEvent() {
  ...
  const createEvent = async (cid) => {
    try {
      const ev3ntsContract = connectContract()
      ...
      if (ev3ntsContract) {
        ...
        const txn = await ev3ntsContract.createNewEvent(eventTimestamp, deposit, maxCapacity, eventDataCID, {
          gasLimit: 900000,
        })
        setLoading(true)
  ...
  return (
    <div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8'>
      <Head>
        <title>Create your event | Ev3nts</title>
            ...
            <div className='space-y-6 sm:space-y-5'>
              ...
              <div className='sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:pt-5'>
                <label htmlFor='date' className='block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2'>
                  Date & time
                  <p className='mt-1 max-w-2xl text-sm text-gray-400'>Your event date and time</p>
                </label>
              ...
              <div className='sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:pt-5'>
                <label htmlFor='max-capacity' className='block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2'>
                  Max capacity
              ...
              <div className='sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:pt-5'>
                <label htmlFor='event-link' className='block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2'>
                  Event link
                  <p className='mt-1 max-w-2xl text-sm text-gray-400'>The link for your virtual event</p>
                </label>
                <div className='mt-1 sm:mt-0 sm:col-span-2'>
                  <input
                    id='event-link'
              ...
              <div className='sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:pt-5'>
                <label htmlFor='about' className='block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2'>
                  Event description
                  <p className='mt-2 text-sm text-gray-400'>Let people know what your event is about!</p>
                </label>
                <div className='mt-1 sm:mt-0 sm:col-span-2'>
                  <textarea
                    id='about'
